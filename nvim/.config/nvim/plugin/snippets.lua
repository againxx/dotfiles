...
vim.keymap.set({ 'i', 's' } , "<C-l>", "<cmd>lua require'luasnip'.expand()<cr>", { silent = true, noremap = true })
vim.keymap.set({ 'i', 's' } , "<M-j>", "<cmd>lua require'luasnip'.jump(1)<cr>", { silent = true, noremap = true })
