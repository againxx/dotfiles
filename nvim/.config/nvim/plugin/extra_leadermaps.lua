...
wk.register({
  ...
  s = {
    ...
    p = { "<cmd>lua require('spectre').open_file_search()<cr>", 'Search and replace in current file' },
...
wk.register({
  s = {
    ...
    w = { "<cmd>lua require('spectre').open_visual()<cr>", 'Search and replace selected content' },
  },
