...
class z(ranger.api.commands.Command):
    ...
    def tab(self, tabnum):
        ...
        completion_directories = subprocess.check_output([PATH_LUA, PATH_ZLUA, '-l', self.arg(1)]).decode().splitlines()
        return ["z " + candidate.split()[-1] for candidate in completion_directories if candidate != '']
